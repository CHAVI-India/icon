...
We are going to be using Djang Allauth for authentication .
"""
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-g#c^l))z(sl+qhz*=q40u5cr#5l=3fxcmg+nt9haukity4r2@d')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DJANGO_DB_NAME', 'icon'),
